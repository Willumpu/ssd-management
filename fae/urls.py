...
urlpatterns = [
    ...
    path('api/project-production-plans/', views.ProjectProductionPlansView.as_view(), name='project_production_plans'),
    ...
    path('issue-daily-report/', views.IssueDailyReportView.as_view(), name='issue_daily_report'),
